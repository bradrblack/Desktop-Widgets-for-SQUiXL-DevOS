...
void Settings::init()
{
	...
	calendar_ics_url.register_option();
	...
	// Clock
	clock_rainbow_option.register_option();
	clock_color_option.register_option();
